...
interface HasForEach<K, V> {
    forEach(callback: (element: V, index: K) => any): any;
}
...
type CollectionKeyOf<T> =
    ...
    T extends HasForEach<infer K, any> ? K :
    Zeta.KeyOf<T>;
type CollectionValueOf<T> =
    ...
    T extends HasForEach<any, infer V> ? V :
    Zeta.ValueOf<T>;
 ...
 */
export function makeArray<T>(obj: T): Zeta.IsAnyOrUnknown<T> extends true ? any[] : T extends (infer U)[] | ArrayLike<infer U> | HasForEach<any, infer U> ? U[] : Exclude<T, null | undefined>[];
 ...
 * @param obj An object.
 * @param callback Function that will be executed in the context of each key-value pair. See explanation for enumerated keys and values below.
 *
 * @description
 * Enumerated keys and values will be:
 * - any types otherwise mentioned below: name and value of enumerable property;
 * - instance of `Array` and array-like objects (see {@link isArrayLike}): array index and element;
 * - instance of `Map`: key and value of each entry;
 * - instance of `Set`: iterated element with incrementing index;
 * - object implementating `entries()`: key and value of iterated entry;
 * - object implementating `nextNode()`: iterated node with incrementing index;
 * - object implementating `next()`: iterated value with incrementing index;
 * - object implementating `forEach(callback)`: key and value being sent to `callback`.
 */
 ...
 * @see {@link each} for enumerated keys and values.
 */
export function any<T>(obj: T, callback?: (this: T, v: CollectionValueOf<T>, i: CollectionKeyOf<T>) => any): CollectionValueOf<T> | false;
 ...
 * @returns A setter function to update the value. It accepts a receiver parameter for objects inheriting the observable property.
 * @see watch
 * @see watchOnce
 */
export function defineObservableProperty<T extends object, P extends keyof T>(obj: T, prop: P, initialValue?: T[P]): (value: T[P], receiver?: T) => void;
 ...
 * @see watchOnce
 */
export function defineObservableProperty<T extends object, V>(obj: T, prop: string, initialValue?: V): (value: V, receiver?: T) => void;
 ...
 * @returns A setter function to update the value. It accepts a receiver parameter for objects inheriting the observable property.
 */
export function defineObservableProperty<T extends object, P extends keyof T>(obj: T, prop: P, initialValue: T[P], callback: (this: T, newValue: T[P], oldValue: T[P]) => T[P]): (value: T[P], receiver?: T) => void;
 ...
 * @returns A setter function to update the value. It accepts a receiver parameter for objects inheriting the observable property.
 */
export function defineObservableProperty<T extends object, V>(obj: T, prop: string, initialValue: V, callback: (this: T, newValue: V, oldValue: V) => V): (value: V, receiver?: T) => void;
 ...
 * @returns A setter function to update the value. It accepts a receiver parameter for objects inheriting the observable property.
 */
export function defineObservableProperty<T extends object, P extends keyof T>(obj: T, prop: P, initialValue: T[P], readonly: true): (value: T[P], receiver?: T) => void;
 ...
 * @returns A setter function to update the value. It accepts a receiver parameter for objects inheriting the observable property.
 */
export function defineObservableProperty<T extends object, V>(obj: T, prop: string, initialValue: V, readonly: true): (value: V, receiver?: T) => void;
